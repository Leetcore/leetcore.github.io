function checkLeet() {
  try {
    ...
    if (now.getHours() == 13 && now.getMinutes() == 37 && loaded == false) {
      loaded = true
      document.getElementById('hacktheplanet').insertAdjacentHTML('beforeend', '<span style="text-align: center; font-size: 200%"><img src="htb.gif" style="width: 80%; margin: 0 auto; display: block;"><p>13:37 Uhr!</p></span>')
